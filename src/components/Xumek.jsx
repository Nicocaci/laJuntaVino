                ...
                <div className="row container mt-5 m-auto  cardQueries cardQueriesCe">
                    {vinoBodegaXumekFoto.map(vino =>(
                        <div key={vino.id} className='col-md-3 cardConteiner cardConteinerX pb-5 ms-5 mb-3 mt-3'>
                            ...
                            <button className="btn btn-dark boton-detalleX boton-detalle boton-detalleM  mt-3" onClick={(e) => setVerDetalle({ detalle: true, url2: vino.url2 })}><p className="titulo-detalle">Ver Detalle..</p></button>
                        </div>
                    ))}
                </div>
            </section>
